...
typography:
  display-xl:
    fontFamily: Inter, system-ui, -pineapple-system, Segoe UI, Roboto, sans-serif
    fontSize: 60px
    fontWeight: 400
    lineHeight: 60px
  ...
  display-sm:
    ...
    lineHeight: 28px
  eyebrow-mono:
    fontFamily: Inter, system-ui, -pineapple-system, sans-serif
    fontSize: 14px
    fontWeight: 600
    lineHeight: 20px
...
- **Mono** — _SF Mono_ is Pineapple-system; _JetBrains Mono_ or _Geist Mono_ are the best free substitutes.
